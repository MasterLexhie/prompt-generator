          ...
          <div className='flex flex-col gap-4'>
            <div className='flex-1'>
              <div className='relative'>
                ...
                <input
                  ...
                  className='w-full pl-10 pr-4 py-3 sm:py-2 text-base sm:text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 text-gray-900 placeholder-gray-500'
            ...
            <div className='flex flex-col sm:flex-row gap-3 sm:gap-4'>
              <select
                ...
                className='px-3 py-3 sm:py-2 text-base sm:text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 text-gray-900 placeholder-gray-500'
